...
const navItems = [
  ...
  { to: '/admin/settings', labelKey: 'settings', Icon: IconSettings },
];
      ...
      <main className="flex-1 overflow-auto flex flex-col">
        <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-6 py-4 shadow-sm flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* الإشعارات — تؤدي لصفحة الإشعارات */}
            <NavLink
              to="/admin/notifications"
              className="p-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors relative"
